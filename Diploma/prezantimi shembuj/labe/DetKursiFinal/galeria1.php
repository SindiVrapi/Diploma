	...
	<body>
        <nav class = "nav-bar">
         ...
         <div class = "slide hi-slide">
            ...
            <ul>
                <li>
                    <img src = "qendra4.jpg" alt = "">
                </li>
                 <li>
                    <img src = "qendra8.jpg" alt = "">
                </li>
                 <li>
                    <img src = "qendra13.jpg" alt = "">
                </li>
                 <li>
                    <img src = "qendra10.jpg" alt = "">
                </li>
                 <li>
                    <img src = "qendra11.jpg" alt = "">
                </li>
                <li>
                    <img src = "qendra12.jpg" alt = "">
                </li>
                <li>
                    <img src = "qendra14.jpg" alt = "">
                </li>
            </ul>
        </div>
